...
# class StockDDPG:
#     """Deep Deterministic Policy Gradient implementation for stock trading"""
#     def __init__(self, state_size, hidden_size, actor_learning_rate=1e-4, critic_learning_rate=1e-3, gamma=0.99, tau=1e-2, use_cuda=False):
#         # Params
#         self.state_size, self.hidden_size, self.action_size = state_size, hidden_size
#         self.gamma, self.tau = gamma, tau
#         self.use_cuda = use_cuda

#         # Networks
#         self.actor = StockActor(state_size, hidden_size, action_size)
#         self.actor_target = StockActor(state_size, hidden_size, action_size)

#         self.critic = StockCritic(state_size + action_size , hidden_size, action_size)
#         self.critic_target = StockCritic(state_size + action_size, hidden_size, action_size)
