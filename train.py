...
def main():
    ...
    try:
        ...
        agent = AgentDDPG(state_size=24, hidden_size=256, action_size=4, use_cuda=False)
    noise = OUNoise(env.action_space)

    trainer = ReinforcementTrainer(env, agent, noise)
    trainer.train(episodes=500, timesteps=1000, batch_size=128, plot=True, log=True, save_path='bipedal_ddpg.pkl')
